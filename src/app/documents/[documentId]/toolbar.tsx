        ...
        </button>
        {
            isEditing ? (
                ...
                onClick={() => {
                 ...
                 className="h-7 w-12 text-sm text-center border border-neutral-400 rounded-sm  hover:bg-neutral-200/80">
                        {currentFontSize}
                </button>
            )
        }
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent>
                    ...
                    <Input placeholder="Insert image URL" value={imageUrl} onChange={(e) => setImageUrl(e.target.value)}
                        onKeyDown={(e) => {
                            if (e.key === "Enter") {
                                handelImageUrlSubmit();
                            }
                        }}
                    />
                    <DialogFooter>
                        <Button onClick={handelImageUrlSubmit}>
                            Insert
                        </Button>
                    </DialogFooter>
                </DialogContent>
            ...
            <DropdownMenuContent className="p-1 flex flex-col gap-y-1">
                {
                    fonts.map(({ label, value }) => (
                        <button
                            ...
                            key={value} className={cn("flex items-center gap-x-2 px-2 py-1 rounded-sm hover:bg-neutral-200/80", editor?.getAttributes("textStyle").fontFamily === value && "bg-neutral-200/80")} style={{ fontFamily: value }}>
            ...
            [
                {
                    ...
                    isActive: editor?.isActive("liveblocksCommentMark"), // TODO enable function at
                },
                {
                    label: "List Todo",
                    icon: ListTodoIcon,
