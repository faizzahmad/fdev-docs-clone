            ...
            <Carousel>
                <CarouselContent className="-ml-4">
                    ...
                    templates.map((templates) => (
                        <CarouselItem key={templates.id}
                        className="basis-1/2 sm:basis-1/3 md:basis-1/4 lg:basis-1/5 xl:basis-1/6 2xl:basis-[14.285715%] pl-4">
                        <div className={cn(
